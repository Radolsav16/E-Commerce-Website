export default function StartSection(){
  ...
  <div className="row text-center pt-5 pb-3">
    <div className="col-lg-6 m-auto">
      ...
      <p>
      We offer a wide range of trendy clothes, stylish accessories, elegant watches, and home essentials, all with secure shopping and fast delivery. Our dedicated customer support and hassle-free return policies ensure a smooth and worry-free shopping experience.
      </p>
    </div>
  </div>
  <div className="row">
