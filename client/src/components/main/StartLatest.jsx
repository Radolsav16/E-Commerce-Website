export default function StratLatest(){
    return(
        <>
  ...
  <div className="container py-5">
    <div className="row text-center py-3">
      <div className="col-lg-6 m-auto">
        ...
        <p>
        Stay ahead of the trends with our newest arrivals! From fashionable outfits to must-have accessories, timeless watches, and elegant home essentials, our latest products are here to upgrade your style and lifestyle.
        </p>
      </div>
    </div>
    <div className="row">
